...
- [x] 新增 `antagonist_plans`
- [x] 显式记录反派目标、当前动作、下一步反制
- [x] 每卷至少有一轮“反派升级”节点
- [x] 审校器检查“主角是否一直单向推进、反派是否失踪”
...
- [ ] contract 字段至少包括：
  ...
  - [x] 伏笔埋设/回收
  - [x] 尾钩
- [x] draft 完成后自动对照 contract 做偏差审校
...
- [x] 建立 1 套样书评测套件，含 3 个 benchmark case
- [x] 建立“末日囤货 / 玄幻升级 / 都市悬疑”三种类型基线
- [ ] 建立人工评分标准
- [ ] 建立自动对比回归流程
...
- [x] `antagonist plans`
- [x] `project review v2`
- [x] `sample-book evaluation suite`
