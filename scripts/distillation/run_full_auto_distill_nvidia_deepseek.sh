...
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL#openai/}"
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL#nvidia/}"
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL#nvidia_nim/}"
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL#deepseek/}"
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL/DeepSeek-V4-Pro/deepseek-v4-pro}"
DEEPSEEK_SUMMARIZER_MODEL="${DEEPSEEK_SUMMARIZER_MODEL/DeepSeek-V4-PRO/deepseek-v4-pro}"
case "${DEEPSEEK_SUMMARIZER_MODEL}" in
  openai/*)
    ;;
  *)
    # NVIDIA hosted NIM is OpenAI-compatible. Keep LiteLLM on its OpenAI
    # provider path; the model id remains the NVIDIA catalog id.
    DEEPSEEK_SUMMARIZER_MODEL="openai/${DEEPSEEK_SUMMARIZER_MODEL}"
    ;;
esac
