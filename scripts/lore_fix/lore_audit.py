...
RULES = [
    ...
    {"id": "R002", "severity": "critical", "category": "timeline",
     "desc": "父亲死亡时间矛盾(非18年)",
     "patterns": [r"父亲.{0,6}(?:三年|3年)前?(?:死|去世|临终|咽气|陨落|殒命)",
                  r"(?:三年|3年)前.{0,6}父亲.{0,4}(?:死|亡|殒)",
                  r"(?:三年|3年).*(?:假死|病亡).*(?:父亲|父)"],
     "hint": "vol1-vol2保留'失踪'；vol3后改为'十八年前'"},
    {"id": "R003", "severity": "critical", "category": "character_identity",
     "desc": "陈天命被错误描述为陈机兄长",
     "patterns": [r"陈天命.{0,10}(?:兄长|哥哥|大哥|弟弟)",
                  r"(?:兄长|大哥).{0,10}陈天命",
                  r"陈天命.{0,6}(?:叔父|亲弟弟|父亲的弟弟)",
                  r"(?:三兄妹).*陈天命|陈天命.*(?:三兄妹)"],
     "hint": "陈天命=同姓非亲，改为'那个同姓之人'或'宿敌'"},
    ...
    {"id": "R102", "severity": "high", "category": "timeline",
     "desc": "陈机入宗时间矛盾(非10年)",
     "patterns": [r"(?:入宗|来到天青宗|进入天青宗)[^。]{0,20}(?:三年|五年)[前了]",
                  r"(?:三年|五年)[前了][^。]{0,20}(?:入宗|进宗)"],
     "hint": "统一改为'十年前'"},
    ...
    {"id": "R104", "severity": "high", "category": "if_residual",
     "desc": "交互式choice标签残留",
     "patterns": [r"请选择[你的]", r"选项[ABC]", r"你选择了[^。，]{1,20}[。]", r"【选择"],
     "hint": "删除交互残留"},
    ...
    {"id": "R202", "severity": "medium", "category": "language",
     "desc": "陈年应统一为陈安",
     "patterns": [r"陈年(?=[的说道笑看走站坐握紧抬低转被将与和也却已还在，。！？\n])"],
     "hint": "改为'陈安'"},
]
