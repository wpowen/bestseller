...
class StoryFacets(BaseModel):
    ...
    The creation workflow supplies an authoritative GenreIntentContract for the
    selected genre/sub-genre.  Story Architect generates only the remaining
    surface facets; it must not reinterpret the taxonomy selection.
    """
