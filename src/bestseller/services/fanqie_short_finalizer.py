...
def _opening_patch(protagonist_name: str, *, genre: str) -> str:
    ...
    if any(token in genre for token in ("现实", "家庭", "情感", "都市", "职场", "校园")):
        return "\n\n".join(
            [
                f"{subject}被堵在会议室时，那份“自愿担责”的说明已经拍在桌上。对方逼{subject}当场签字；不签，明天整栋楼的人都会把那场事故算在{subject}头上。",
                f"{subject}手腕被按得发麻，却先看见说明末尾那行被人改过的时间。改动的笔迹很新，新得来不及干透。",
                f"{subject}没有靠山，也没有人撑腰，只有一份被揉皱的原始记录和十分钟倒计时。可这份记录足够成为证据。",
                f"“签。”对方把笔塞进{subject}手里，“你不签，今天谁都别想走。”",
                f"{subject}反手把原始记录拍在桌面上，直接点名让在场的人当面核对时间。屋里安静了一秒，对方脸色瞬间变了。",
                f"这是第一件反击的证据。{subject}没慌，也没求他，只把录音键打开：“现在说清楚，那天到底是谁改的记录？”",
            ]
        )
    return "\n\n".join(
        [
...
_EXPANSION_PARAGRAPHS = (
    "复盘的时候，{subject}才看见自己过去错过了多少细节。每一次对方声称迫不得已，事后都有一处对不上的说辞；每一次对方指责别人不懂事，又会在旁人面前把受害者的忍让说成自己的功劳。那些矛盾不是巧合，是他早就把别人的退让当成理所当然。",
    "最难的一晚不是对峙那天，而是真相落定以后。四周终于安静，消息也不再涌来，{subject}却反复确认那些证据还在。人被逼久了，会下意识怀疑自己是不是太狠；直到看见身边的人终于睡得安稳，{subject}才知道那不是狠，是自保。",
    "后来有人递来道歉信，话写得很满，落款也很诚恳。{subject}没有当场原谅，只把信收进文件袋。清白本来就不该靠迟来的歉意兑换，伤口也不是一句误会就能合上。能被公开承认，已经是第一步；能不能被原谅，是另一回事。",
    "身边的人开始重新学着说话。过去一句“都是为你好”就能压住所有反抗，现在谁再开口，都要先把事实说清楚。那种安静起初让人不习惯，却终于不再像审判。{subject}第一次发现，亲近的关系如果拿掉控制，也许笨拙，但至少能让人喘气。",
    "被拖累的人恢复得很慢，走几步就要停下，夜里还会被噩梦惊醒。{subject}没有再替她决定一切，只陪她把属于她自己的东西一件件收回来。真正的胜利不是有人替她出头，而是她终于敢说：这些事以后我自己做主。",
    "流言散去后，生活没有立刻变好。该跑的手续还要跑，旧关系留下的麻烦也不会自动消失。可{subject}不再觉得自己被困住。只要那张不该签的纸已经作废，只要作恶的人付出代价，路就会从最窄的地方重新出现。",
