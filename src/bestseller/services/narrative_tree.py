...
_NODE_TITLES = {
    ...
    "deferred_reveals": ("Deferred Reveals Ledger", "延后揭示登记表"),
    ...
    "clues_ledger": ("Clues & Payoffs Ledger", "线索与兑现登记表"),
    "foreshadowing_ledger": ("Foreshadowing Ledger", "伏笔登记表"),
    "payoff_ledger": ("Payoff Ledger", "兑现登记表"),
