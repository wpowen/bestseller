...
def build_scene_review_prompts(
    ...
    system_prompt = (
        (
            ...
            "3. If axis 2 or axis 6 FAILS, verdict = rewrite regardless of other axes; otherwise if ≥2 axes FAIL, verdict = rewrite; else pass\n"
        ...
        if is_en
            ...
            "3. 第 2 项或第 6 项 FAIL → 无论其他轴一律 verdict = rewrite；否则 ≥ 2 项 FAIL → rewrite；否则 pass\n"
