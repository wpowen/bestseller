...
# 2026-08-23 从 150 抬到 240：真机观测判官在供应商延迟高峰连续超时，
# 而提升资格现在认它的判决（66264a7）——超时=语义层跳过=该章失去提升
# 资格，代价比从前大得多。240s 仍有界（多采样并发，取决于最慢样本）。
_OPTIONAL_CHAPTER_REVIEW_LLM_TIMEOUT_SECONDS = 240.0
