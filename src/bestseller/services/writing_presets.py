...
_PLATFORM_PRESETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "source_refs": [
            "https://www.qimao.com/",
            "https://bbs.qimao.com/column/6859f2539995c",
        ],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "七猫小说",
                "content_mode": "七猫移动端免费阅读商业连载",
                "reader_promise": "第一页给压力和问题，前三章给主角优势与小爽点，前一万字证明可持续追读循环。",
                "selling_points": ["第一页强冲突", "主角强代入", "前三章小爽点", "前一万字连续追读"],
                "hook_keywords": ["危机", "误会", "损失", "反打", "利益诱因", "未完成动作"],
                "opening_contract": "第一章禁止普通日常/背景/风景开场；必须从异常、危机、误会、侮辱、损失、利益冲突或被迫选择切入。",
                "opening_strategy": "前100字聚焦主角，前200字出现可感冲突，前600字让核心矛盾可读，第一章完成吸引-代入-期待闭环。",
                "chapter_hook_strategy": "每章结尾必须留下问题、威胁、反转、利益诱因或未完成动作，不能平收。",
                "hook_deadline_words": 600,
                "payoff_rhythm": "短回报密集，前三章至少一次小爽点或小爆点，过渡章也要有小冲突/小收益/小信息差。",
                "update_strategy": "稳定日更，签约前按前一万字留存效果优先修稿",
            },
            "style": {
                "prose_style": "commercial-web-serial",
                "sentence_style": "short-punchy",
                ...
                "custom_rules": [
                    ...
                    "正文必须保留作者视角、具体动作和人物口气，避免模板化AI腔。",
                ],
            },
            "serialization": {
                "opening_mandate": "第一章必须以主角身上的异常/危机/误会/侮辱/损失/利益冲突/被迫选择开场，不允许先铺背景。",
                "first_three_chapter_goal": "第1章立冲突，第2章亮差异化优势或金手指，第3章完成第一次小爽点或小爆点并留下下一轮钩子。",
                "scene_drive_rule": "每场必须完成 goal -> resistance -> escalation/info change -> reward/cost -> next hook。",
                "exposition_rule": "设定只能夹在人物行动、冲突、交易、失败和后果里释放，禁止百科式开场。",
                "chapter_ending_rule": "章尾必须有下一章点击理由：问题、威胁、反转、利益诱因或未完成动作。",
                "free_chapter_strategy": "前一万字只围绕一条主线推进，连续证明触发冲突、主角行动、反转/收益、新钩子的核心循环。",
            },
        },
    },
    {
...
_GENRE_PRESETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "trend_score": 89,
        "trend_window": "2025-2026",
        "trend_summary": "末日规则求生靠规则发现、试错代价和团队博弈持续追读，是末日线里仅次于囤货流的强需求。",
        "trend_keywords": ["末日规则", "规则求生", "试错代价", "团队博弈"],
        "name": "末日规则求生流",
        "genre": "末日科幻",
        "sub_genre": "规则生存",
    ...
    },
    {
        ...
        "trend_score": 83,
        "trend_window": "2025-2026",
        "trend_summary": "末日基建把据点经营、生产链和势力对抗做成长线爽点，适合追求规模感和经营成长的读者。",
        "trend_keywords": ["末日基建", "基地经营", "势力对抗", "生产链"],
        "name": "末日基建势力流",
        "genre": "末日科幻",
        "sub_genre": "基地经营",
    ...
    },
    {
        ...
        "trend_score": 87,
        "trend_window": "2025-2026",
        "trend_summary": "都市异能反转是番茄常青盘，靠现实压迫、能力外挂和连环打脸维持高追读。",
        "trend_keywords": ["都市异能", "身份反转", "打脸", "爽点兑现"],
        "name": "都市异能反转流",
        "genre": "都市异能",
        "sub_genre": "身份反转",
    ...
    },
    {
        ...
        "trend_score": 79,
        "trend_window": "2025-2026",
        "trend_summary": "都市黑科技创业兼顾技术碾压和事业成长，受众偏好产业博弈和资本对抗的稳定读者群。",
        "trend_keywords": ["黑科技", "创业", "产业博弈", "技术打脸"],
        "name": "都市黑科技创业流",
        "genre": "都市异能",
        "sub_genre": "黑科技创业",
    ...
    },
    {
        ...
        "trend_score": 81,
        "trend_window": "2025-2026",
        "trend_summary": "历史争霸权谋走长线谋略和制度经营，受众忠诚但拉新偏慢，适合卷级结构作品。",
        "trend_keywords": ["历史争霸", "权谋", "战争经营", "版图扩张"],
        "name": "历史争霸权谋流",
        "genre": "历史权谋",
        "sub_genre": "争霸经营",
    ...
    },
    {
        ...
        "trend_score": 85,
        "trend_window": "2025-2026",
        "trend_summary": "都市悬疑追凶靠案件节奏、误导反转和人物秘密支撑追读，影视化潜力强。",
        "trend_keywords": ["悬疑推理", "连环追凶", "误导反转", "刑侦"],
        "name": "悬疑推理追凶流",
        "genre": "悬疑推理",
        "sub_genre": "连环追凶",
    ...
    },
    {
        ...
        "trend_score": 84,
        "trend_window": "2025-2026",
        "trend_summary": "无限流闯关用副本差异和主线谜题做长线推进，悬念驱动型读者粘性高。",
        "trend_keywords": ["无限流", "副本闯关", "主线谜题", "生存博弈"],
        "name": "无限流闯关流",
        "genre": "奇幻冒险",
        "sub_genre": "无限闯关",
    ...
    },
    {
        ...
        "trend_score": 80,
        "trend_window": "2025-2026",
        "trend_summary": "星际舰队战争吃科幻设定和卷级大战，受众垂直但忠诚，IP 改编想象空间大。",
        "trend_keywords": ["星际战争", "舰队", "科技跃迁", "文明对抗"],
        "name": "星际战争舰队流",
        "genre": "科幻冒险",
        "sub_genre": "星际舰队",
    ...
    },
    {
        ...
        "trend_score": 84,
        "trend_window": "2025-2026",
        "trend_summary": "御兽养成靠宠兽进化、契约搭配和赛事推进做双成长爽点，设定党和升级党都吃。",
        "trend_keywords": ["御兽", "养成进化", "契约搭配", "赛事排名"],
        "name": "御兽养成进化流",
        "genre": "玄幻升级",
        "sub_genre": "御兽养成",
    ...
    },
    {
        ...
        "trend_score": 82,
        "trend_window": "2025-2026",
        "trend_summary": "电竞直播逆袭靠对局反转、直播爆点和战队博弈做强节奏爽文，互动和话题性强。",
        "trend_keywords": ["电竞", "直播逆袭", "战队博弈", "高光对局"],
        "name": "电竞直播逆袭流",
        "genre": "都市竞技",
        "sub_genre": "电竞直播",
    ...
    {
        "key": "folk-occult-trade",
        "name": "民间灵异职业怪谈流",
        "genre": "惊悚灵异",
        "sub_genre": "民俗职业怪谈",
        "description": "以捞尸人、赶尸匠、收尸人、阴婚媒等民间职业为切口，用职业规矩、灵异委托、地方诡谈和因果反转构成强开篇引擎，主角靠手艺与胆识在阴阳两界讨生活。",
        "aliases": ["捞尸人", "赶尸", "民俗", "灵异", "怪谈", "民间职业", "阴阳"],
        "recommended_platforms": ["番茄小说", "起点中文网"],
        "recommended_audiences": ["灵异怪谈读者", "民俗悬疑读者", "强尾钩追读读者"],
        "target_word_options": [22000, 60000, 140000, 300000],
        "target_chapter_options": [4, 10, 26, 55],
        "prompt_pack_key": "suspense-mystery",
        "trend_score": 89,
        "trend_window": "2025-2026",
        "trend_summary": "《捞尸人》式民间职业灵异在番茄持续走高，职业规矩+地方诡谈+因果反转的组合辨识度强、尾钩天然，是灵异线里最易冷启动的细分。",
        "trend_keywords": ["捞尸人", "民间职业", "民俗怪谈", "灵异委托", "因果反转"],
        "trend_source_refs": [
            "https://fanqienovel.com/writer/zone/article/7480087779494346776",
            "https://m.thepaper.cn/newsDetail_forward_30716745",
        ],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "番茄小说",
                "reader_promise": "开篇就亮出主角的诡异职业、第一桩反常委托和不能破的行规，用地方怪谈和因果伏笔连环拉追读。",
                "selling_points": ["民间职业切口", "职业规矩压迫", "地方诡谈", "灵异委托", "因果反转", "阴阳两界"],
                "trope_keywords": ["捞尸人", "赶尸", "民俗", "怪谈", "阴阳", "因果"],
                "hook_keywords": ["反常尸体", "破不得的规矩", "上门委托", "旧案诡变", "还债"],
                "opening_strategy": "第一屏抛出诡异职业现场、一桩违反常理的委托和一条不可触碰的行规。",
                "chapter_hook_strategy": "每章末至少推进一条怪谈线索、一次规矩代价或一层更大的因果真相。",
                "pacing_profile": "fast",
            },
            "character": {
                "protagonist_archetype": "手艺傍身的民间职业者",
                "protagonist_core_drive": "靠手艺与胆识接住每一桩诡事，并解开缠在自己身世上的因果",
                "golden_finger": "祖传职业手艺、阴阳眼或一件镇物/契约",
                "growth_curve": "接单糊口 -> 卷入地方大案 -> 直面因果与幕后",
                "antagonist_mode": "地方诡物与人心算计双线施压",
            },
            "world": {
                "worldbuilding_density": "medium",
                "power_system_style": "职业手艺、民俗规矩与灵异认知并行升级",
                "mystery_density": "high",
                "setting_tags": ["民间职业", "民俗", "怪谈", "阴阳", "因果"],
            },
            "style": {
                "tone_keywords": ["诡", "冷", "民俗感", "悬"],
                "dialogue_ratio": 0.42,
            },
            "hype": _hype_block(_GENERIC_FALLBACK_HYPE_DECK),
        },
    },
    {
        ...
        "genre": "都市娱乐",
        "sub_genre": "娱乐圈逆袭",
        "description": "以选秀、剧组、综艺、热搜和资本博弈为舞台，用实力打脸、身份反差、事业爱情双线和舆论反转制造强追读，主角从查无此人逆袭成顶流。",
        "aliases": ["娱乐圈", "选秀", "顶流", "明星", "热搜", "剧组", "综艺"],
        "recommended_platforms": ["番茄小说", "晋江文学城"],
        "recommended_audiences": ["女频都市读者", "娱乐圈爽文读者", "追星向读者"],
        "target_word_options": [22000, 70000, 150000, 300000],
        "target_chapter_options": [4, 12, 28, 54],
        "trend_score": 85,
        "trend_window": "2025-2026",
        "trend_summary": "娱乐圈逆袭兼具强爽点和高 IP 改编潜力，实力打脸+热搜节奏+事业爱情双线在番茄和晋江都有稳定盘。",
        "trend_keywords": ["娱乐圈", "顶流逆袭", "实力打脸", "热搜节奏", "事业爱情双线"],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "番茄小说",
                "reader_promise": "开篇就把主角的被埋没实力、一次当众翻盘机会和娱乐圈的现实规则一起亮出来。",
                "selling_points": ["实力打脸", "顶流逆袭", "热搜爆点", "事业爱情双线", "资本博弈", "舆论反转"],
                "trope_keywords": ["娱乐圈", "选秀", "顶流", "打脸", "热搜", "逆袭"],
                "hook_keywords": ["现场翻盘", "热搜反转", "资源争夺", "黑料反杀", "顶流邀约"],
                "pacing_profile": "fast",
            },
            "character": {
                "protagonist_archetype": "被低估的实力型新人",
                "protagonist_core_drive": "用实力和作品打破偏见，在名利场站到顶端并守住本心",
                "golden_finger": "前世记忆、专业积累或独到审美/天赋",
            },
            "world": {
                "worldbuilding_density": "light",
                "setting_tags": ["娱乐圈", "剧组", "综艺", "资本", "舆论"],
            },
            "style": {
    ...
    },
    {
        ...
        "genre": "玄幻穿越",
        "sub_genre": "异界崛起",
        "description": "现代人意外穿越到剑与魔法或多族争雄的异世大陆，靠现代认知、系统或绝世功法从底层一路崛起为霸主，强调世界观扩张与跨阶碾压。",
        "aliases": ["穿越", "异世大陆", "异界", "崛起", "系统", "剑与魔法", "争霸"],
        "recommended_platforms": ["起点中文网", "番茄小说"],
        "recommended_audiences": ["男频升级读者", "异世设定党", "长线爽文读者"],
        "target_word_options": [30000, 100000, 220000, 500000],
        "target_chapter_options": [5, 18, 40, 90],
        "prompt_pack_key": "xianxia-upgrade-core",
        "trend_score": 84,
        "trend_window": "2025-2026",
        "trend_summary": "异世大陆穿越崛起是男频常青母题，现代认知差+系统/功法+霸主成长曲线在起点和番茄都有长线盘，胜在地图与世界观可持续扩张。",
        "trend_keywords": ["异世穿越", "异界崛起", "现代认知差", "升级争霸"],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "起点中文网",
                "reader_promise": "尽快让读者看到主角的穿越身份、现代认知差和第一次打破异界阶层压制的机会。",
                "selling_points": ["现代认知差", "系统/功法", "跨阶碾压", "势力崛起", "世界地图扩张"],
                "trope_keywords": ["穿越", "异界", "崛起", "系统", "争霸"],
                "hook_keywords": ["穿越觉醒", "异界险境", "降维打击", "上位势力", "新地图"],
                "pacing_profile": "fast",
            },
            "character": {
                "protagonist_archetype": "携现代认知逆袭的穿越者",
                "protagonist_core_drive": "在陌生异界活下来，并把自己的规则推上大陆之巅",
                "golden_finger": "现代知识、穿越系统或绝世功法/血脉",
                "growth_curve": "异界求生 -> 势力立足 -> 大陆争霸",
                "antagonist_mode": "本土强权与异族势力双重压制",
            },
            "world": {
                "worldbuilding_density": "high",
                "power_system_style": "等级体系与势力规模同步升级",
                "setting_tags": ["异世大陆", "剑与魔法", "多族争雄", "争霸"],
            },
            "style": {
    ...
    {
        "key": "sweet-romance-ceo",
        "name": "现代甜宠总裁言情流",
        "genre": "现代言情",
        "sub_genre": "甜宠总裁",
        "description": "以高位男主与清冷或元气女主的双向奔赴为核心，用身份差、强势宠爱、轻虐反转和高糖名场面制造情绪兑现，主打甜中带虐的恋爱快感。",
        "aliases": ["现代言情", "甜宠", "总裁", "霸总", "双向奔赴", "撒糖", "灰姑娘"],
        "recommended_platforms": ["番茄小说", "晋江文学城"],
        "recommended_audiences": ["女频言情读者", "甜宠党", "情绪价值向读者"],
        "target_word_options": [22000, 70000, 150000, 280000],
        "target_chapter_options": [4, 12, 28, 50],
        "prompt_pack_key": "romance-tension-growth",
        "trend_score": 84,
        "trend_window": "2025-2026",
        "trend_summary": "现代甜宠仍是女频的情绪基本盘，身份差+强势宠爱+轻虐反转的高糖名场面在番茄和晋江都稳定吃量，短剧改编需求旺。",
        "trend_keywords": ["甜宠", "总裁言情", "双向奔赴", "撒糖", "情绪价值"],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "番茄小说",
                "reader_promise": "开篇就给出男女主的身份差、强吸引力的初遇和第一颗能立刻兑现的糖。",
                "selling_points": ["身份差", "强势宠爱", "双向奔赴", "高糖名场面", "轻虐反转"],
                "trope_keywords": ["甜宠", "总裁", "灰姑娘", "撒糖", "宠妻"],
                "hook_keywords": ["命运初遇", "高调宣示", "误会拉扯", "强势护短", "甜虐反转"],
                "pacing_profile": "medium-fast",
            },
            "character": {
                "protagonist_archetype": "清冷或元气的女主与高位深情男主",
                "protagonist_core_drive": "在身份与现实落差中确认彼此并守住这段关系",
            },
            "world": {
                "worldbuilding_density": "light",
                "setting_tags": ["现代都市", "豪门", "职场", "校园"],
            },
            "style": {
                "tone_keywords": ["甜", "撩", "细腻", "心动"],
                "dialogue_ratio": 0.5,
            },
            "hype": _hype_block(_GENERIC_FALLBACK_HYPE_DECK),
        },
    ...
    {
        "key": "cyberpunk-nearfuture",
        "name": "赛博朋克近未来流",
        "genre": "科幻冒险",
        "sub_genre": "赛博近未来",
        "description": "把高科技与低生活的赛博都市做成舞台，用义体改造、AI 觉醒、虚拟实境和巨企阴谋构成强设定钩子，主角在霓虹与数据洪流里逆流求生。",
        "aliases": ["赛博朋克", "近未来", "义体", "AI", "虚拟实境", "巨企", "黑客"],
        "recommended_platforms": ["起点中文网", "番茄小说"],
        "recommended_audiences": ["科幻设定党", "赛博美学读者", "高概念剧情读者"],
        "target_word_options": [24000, 80000, 160000, 320000],
        "target_chapter_options": [4, 14, 30, 58],
        "prompt_pack_key": "scifi-starwar",
        "trend_score": 80,
        "trend_window": "2025-2026",
        "trend_summary": "赛博朋克近未来吃强设定和美学辨识度，义体改造、AI 觉醒和巨企阴谋适合做高概念钩子，受众垂直但风格化突出、IP/游戏化想象空间大。",
        "trend_keywords": ["赛博朋克", "近未来", "义体", "AI觉醒", "虚拟实境"],
        "writing_profile_overrides": {
            "market": {
                "platform_target": "起点中文网",
                "reader_promise": "开篇就把赛博都市的高科技低生活、主角的生存困局和一项改变命运的技术/义体亮出来。",
                "selling_points": ["赛博美学", "义体改造", "AI觉醒", "虚拟实境", "巨企阴谋"],
                "trope_keywords": ["赛博朋克", "义体", "黑客", "AI", "巨企"],
                "hook_keywords": ["义体升级", "数据入侵", "AI异动", "巨企追杀", "虚实切换"],
                "pacing_profile": "medium-fast",
            },
            "character": {
                "protagonist_archetype": "霓虹底层的逆流求生者",
                "protagonist_core_drive": "在巨企与AI夹缝中改写自己被定义的命运",
                "golden_finger": "稀有义体、独门黑客技艺或与AI的特殊链接",
            },
            "world": {
                "worldbuilding_density": "high",
                "power_system_style": "义体、技术权限与数据能力并行升级",
                "mystery_density": "high",
                "setting_tags": ["赛博都市", "义体", "虚拟实境", "巨企", "AI"],
            },
            "style": {
                "tone_keywords": ["冷冽", "霓虹", "未来感", "压迫"],
            },
            "hype": _hype_block(_GENERIC_FALLBACK_HYPE_DECK),
        },
    },
